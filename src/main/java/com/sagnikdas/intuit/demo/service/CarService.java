...
public class CarService {
    ...
    public CustomComparisonResponse getCustomComparisonResponse(List<String> vinIds, boolean doShowDifference, Map<CarVectorEnum, ArrayList<String>> featureMetaDataMap, Map<String, ArrayList<String>> diffFeatureMetaDataMap) throws VinNotFoundException {
